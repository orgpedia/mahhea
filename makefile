...
import/websites/gr.maharashtra.gov.in/Health:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Health .
...
import: check_env import/websites/gr.maharashtra.gov.in/Health .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Health import/documents
